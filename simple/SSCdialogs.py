import dialogs, ui, collections, datetime, photos, re, hashlib, console, ModCameraScanner
...
class _SCFormDialogController (object):
	...
	def take_photo(self, sender):
		...
		self.image = ModCameraScanner.main()
		if self.image:
			#TODO: name image file with a unique hash
...
def SCform_dialog(title='', fields=None, sections=None, done_button_title='Done', font=None, frame=None):
	...
	c = _SCFormDialogController(title, sections, done_button_title=done_button_title, font=font)
	if frame:
